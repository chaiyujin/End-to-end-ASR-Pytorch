...
from src.spectrogram import mel_spectrogram
...
def extract_feature(
    input_file, feature='fbank', dim=40, sr=16000,
    cmvn=False, delta=False, delta_delta=False,
    ...
    if feature == 'fbank':
        ...
        feat = librosa.feature.mfcc(
            y=y, sr=sr, n_mfcc=dim, n_mels=26,
